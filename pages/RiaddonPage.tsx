...
const CategoryCard: React.FC<{ icon: React.ElementType, title: string, description: string }> = ({ icon: Icon, title, description }) => (
    <div className="bg-[#1A202C] p-6 rounded-lg text-center border border-gray-700 hover:border-blue-500 transition-all duration-300 transform hover:-translate-y-1">
...
const Step: React.FC<{ number: string, title: string, description: string }> = ({ number, title, description }) => (
    <div className="flex flex-col items-center text-center">
        <div className="flex-shrink-0 h-12 w-12 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold text-xl">{number}</div>
        ...
        <div className="bg-[#0B101B] text-white">
            <section className="py-20 md:py-32">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        <h1 className="text-4xl md:text-5xl font-extrabold text-white leading-tight">Supercharge Your Store with RIAddon</h1>
                        <p className="mt-6 text-lg text-gray-300">Discover powerful extensions, integrations, and apps in the RIAddon Marketplace. Customize your Rietail store to meet your unique business needs and unlock new capabilities.</p>
            ...
            <section className="py-20 bg-[#101622]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <p className="mt-4 text-gray-400">From marketing and SEO to shipping and fulfillment, our marketplace is filled with high-quality apps to help you grow your business and streamline your operations.</p>
                    </div>
            ...
            <section className="py-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-gray-800 rounded-2xl p-12 grid md:grid-cols-2 gap-12 items-center border border-gray-700">
                        <div className="flex justify-center">
