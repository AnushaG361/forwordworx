...
const AutomationAgentServicePage: React.FC = () => {
    return (
        <div className="bg-white font-sans text-gray-900">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
                <Breadcrumbs items={[{ label: 'Home', path: '/' }, { label: 'Services', path: '/services' }, { label: 'Automation Agent' }]} />
            </div>
            <section className="py-24 text-center bg-green-50">
                <div className="max-w-4xl mx-auto px-4">
                     <div className="inline-flex items-center justify-center p-4 bg-white rounded-2xl shadow-sm mb-8">
                        <AutomationIcon className="h-10 w-10 text-green-600" />
                    </div>
                    <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-6 text-gray-900">Automation Agent</h1>
                    <p className="text-xl text-gray-600 mb-10">Eliminate manual work. Intelligent workflows connecting CRM, HR, and operations.</p>
                    <Link to="/contact" className="bg-green-600 text-white font-bold py-4 px-10 rounded-full text-lg hover:bg-green-700 shadow-lg">Automate Now</Link>
                </div>
            </section>
...
export default AutomationAgentServicePage;
