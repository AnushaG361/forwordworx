...
const StudioAgentPage: React.FC = () => {
    return (
            ...
            <section className="relative py-24 md:py-32 overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <p className="text-xl text-gray-600 mb-10 leading-relaxed">
                        Studio solutions for catalog, campaigns, and brand identity.
                    </p>
            ...
            <section className="py-24 bg-white text-center">
                <div className="max-w-4xl mx-auto px-4">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        ...
                        <Link to="/services#pricing" className="inline-flex items-center justify-center bg-white border-2 border-gray-200 text-gray-900 font-bold py-4 px-12 rounded-full text-lg hover:bg-gray-50 transition-all">
                            View Plans
                        </Link>
                    </div>
                </div>
...
export default StudioAgentPage;
