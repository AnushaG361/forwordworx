...
const PricingCard: React.FC<{ plan: string, price: string, description: string, features: string[], popular?: boolean }> = ({ plan, price, description, features, popular }) => (
    <div className={`border rounded-xl p-8 flex flex-col ${popular ? 'border-blue-500 bg-[#151C2C]' : 'border-gray-700'}`}>
        ...
        <p className="mt-2 text-4xl font-extrabold">{price}<span className="text-base font-medium text-gray-400">/mo</span></p>
        <p className="mt-2 text-gray-400 h-12">{description}</p>
        ...
        <div className="mt-8">
            <Link to="/contact" className={`w-full text-center font-bold py-3 px-6 rounded-lg transition-transform transform hover:scale-105 inline-block ${popular ? 'bg-blue-600 text-white hover:bg-blue-700' : 'bg-gray-700 text-white hover:bg-gray-600'}`}>
                Get Started
            </Link>
        </div>
    </div>
        ...
        <div className="bg-[#0B101B] text-white">
            ...
            <section className="relative py-32 md:py-48 text-center bg-cover bg-center" style={{ backgroundImage: "url('https://picsum.photos/seed/seobg/1200/800')" }}>
                ...
                <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h1 className="text-5xl md:text-7xl font-extrabold">Dominate Search & Social</h1>
                    <p className="mt-4 text-xl md:text-2xl text-gray-300">Comprehensive SEO & SMO subscription plans to boost your online visibility and drive organic growth.</p>
                    <div className="mt-8">
                        <a href="#pricing" className="inline-block bg-blue-600 text-white font-bold py-3 px-8 rounded-lg text-lg hover:bg-blue-700 transition-transform transform hover:scale-105">
                            View Plans
                        </a>
                    </div>
                </div>
            ...
            {/* Pricing Section */}
            <section id="pricing" className="py-20 md:py-28 bg-[#101622]">
                 <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto">
                        <h2 className="text-4xl font-bold">Flexible Plans for Every Business</h2>
                        <p className="mt-4 text-lg text-gray-400">Choose the subscription that fits your goals and budget. No hidden fees, just results.</p>
                    </div>
